...
cl = BE_Team(myToken="4kvDerrKCftJXEbNa34N1dhRrcx3l9r4XMqRmbNIg98Xvckle56vOELpc+mz9zkBOb613KZNR5pK5LikxrMEJEWKwffze3NG/f+Xq6YM45eOa1kvBD5lnOWxy77uXDy",
            myApp="ANDROIDLITE\t2.14.0\tAndroid OS\t5.1.1")
c1 = BE_Team(myToken="4kvDerrKCftJXEbNa34N1dhRrcx3l9r4XMqRmbNIg98Xvckle56vOELpc+mz9zkBOb613KZNR5pK5LikxrMEJEWKwffze3NG/f+Xq6YM45eOa1kvBD5lnOWxy77uXDy",
            myApp="ANDROIDLITE\t2.13.0\tAndroid OS\t6.0.1")
c2 = BE_Team(myToken="4kvDerrKCftJXEbNa34N1dhRrcx3l9r4XMqRmbNIg98Xvckle56vOELpc+mz9zkBOb613KZNR5pK5LikxrMEJEWKwffze3NG/f+Xq6YM45eOa1kvBD5lnOWxy77uXDy",
            myApp="ANDROIDLITE\t2.13.2\tAndroid OS\t7.0")
selfmid = cl.profile.mid
C1mid = c1.profile.mid
C2mid = c2.profile.mid
creator = ["u3b5bfc8413205ebfcb4aeb20bc55f915"]
bot = [cl, c1, c2]
Botmid = [selfmid, C1mid, C2mid]
try:
    cl.findAndAddContactsByMid("u3b5bfc8413205ebfcb4aeb20bc55f915")
    cl.sendMessage("u3b5bfc8413205ebfcb4aeb20bc55f915", "ini akun saya")
except:pass
wait = {
    "autoJoin": True,
    "blacklist":{}
        ...
        if op.type in [25, 26]:
            ...
            if cmd == "cek":
                if sender in creator:
                    cl.sendMessage(to,'allo')
                    c1.sendMessage(to,'allo')
                    c2.sendMessage(to,'allo')
